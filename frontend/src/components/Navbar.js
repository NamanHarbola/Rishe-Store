        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              ...
              <Button onClick={signInWithGoogle} className="bg-emerald-600 hover:bg-emerald-700" data-testid="signin-btn">
                Sign In
              </Button>
            )}
          </div>
          ...
          >
            <div className="px-4 py-4 space-y-3">
              ...
              {user ? (
                ...
                <button onClick={signInWithGoogle} className="w-full btn-primary">
                  Sign In
                </button>
              )}
            </div>
