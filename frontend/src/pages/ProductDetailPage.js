      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              {product.images.map((image, index) => (
                ...
                >
                  <img src={image.url} alt={`${product.name} ${index + 1}`} className="w-full aspect-square object-cover" />
                </button>
              ))}
            </div>
          </div>
          ...
          >
            ...
            <p className="text-3xl font-bold text-emerald-600 mb-6" data-testid="product-price">₹{product.price}</p>
                ...
                {product.variants?.map((variant, index) => (
                  <button
                    ...
                    className={`relative w-12 h-12 rounded-full border-2 ${
                      selectedVariant?.color === variant.color ? 'border-emerald-600' : 'border-gray-300'
                    }`}
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-lg font-semibold transition-all ${
                        selectedSize === size
                          ...
                          : 'bg-white border-2 border-gray-300 hover:border-emerald-600'
                      }`}
